...
| `03-asset-surface-history.png` | Asset Surface saved history | Saved local Asset Surface analyses after running the sample inventory, including reload/delete controls and high-level counts. |
